...
import { EmailValuesDto } from 'src/app/shared/model/email-values-dto';
...
export class SendEmailComponent implements OnInit{
  ...
  optionsForm: Forms[];
  constructor(private fb: FormBuilder, private emailPasswordService: EmailPasswordService,
  ...
  ngOnInit(): void {
    this.optionsForm=[
      ...
      mailTo: ['',  [Validators.required, Validators.minLength(8), Validators.maxLength(30), Validators.email]],
  })
  }
